const TestRail = require('cypress-testrail/src/components/TestRail/TestRail');
const TestCaseParser = require('cypress-testrail/src/services/TestCaseParser');
const Result = require('cypress-testrail/src/components/TestRail/Result');
const ConfigService = require('cypress-testrail/src/services/ConfigService');
const TestData = require('cypress-testrail/src/components/Cypress/TestData');
const ColorConsole = require('cypress-testrail/src/services/ColorConsole');

const packageData = require('cypress-testrail/package.json');
